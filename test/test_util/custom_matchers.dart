...
/// A matcher to verify that a `InvalidPropCombinationError` is thrown with a provided
/// [prop1], [prop2], and [message].
///
/// __Note__: The message is matched rather than the [Error] instance due to Dart's wrapping of all `throw`
///  as a [DomException]
///
...
/// A matcher to verify that the `InvalidPropValueError` is thrown with a provided [value], [name] and [message].
///
